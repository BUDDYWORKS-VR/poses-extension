BUDDYWORKS Pose System v1 (For GogoLoco 1.8.3)

Thank you for grabbing the BUDDYWORKS Pose System.
...
# Dependencies:
- GogoLoco in the correct Version
- VRCFury
...
3. Add the following to your parameter list:
Go/VRCEmote as Int - Not Saved - Synced
Go/Float as Float - Not Saved - Synced
You can also merge "ParametersToMerge" onto your avatar, or use VRCSDK+ to add them to your parameter list.
